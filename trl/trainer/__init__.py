...
_import_structure = {
    ...
    "custom_grpo_trainer": ["Custom_GRPOTrainer"],
    ...
    "custom_rloo_trainer": ["Custom_RLOOTrainer"],
...
if TYPE_CHECKING:
    ...
    from .custom_grpo_trainer import Custom_GRPOTrainer
    ...
    from .custom_rloo_trainer import Custom_RLOOTrainer
